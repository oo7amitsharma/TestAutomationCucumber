...
//@CucumberOptions(strict = true, monochrome = true, features = "src/test/resources/features", glue = "stepdefinition", format = {"pretty","json:target/cucumber.json"}, tags = { "~@Ignore" })
...
public class CucumberRunner extends AbstractTestNGCucumberTests {
	...
	public static String purchaseAmount = null;
